        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h1 class="card-title">{{ __('Users list') }}</h1>
                ...
                <div class="card-body">
                    {{-- Data table --}}
                    <table class="table table-striped table-bordered nowrap TableStyle" id="users-table">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>{{ $user->email }}</td>
                                <td>
                                    <a class="btn btn-primary" href="{{ 'users/'. $hashids->encode($user->id) }}" role="button">
...
@section('js')
    <script>
        ...
        function filterColumn ( i ) {
            jQuery('#users-table').DataTable().column( i ).search(jQuery('#col'+i+'_filter').val()).draw();
        }
