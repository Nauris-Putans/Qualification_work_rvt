                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-warning mr-1" href="{{ URL::to('/admin/roles/'. $hashids->encode($role->id) . '/edit') }}" role="button">
                                        {{ __('Edit') }}</a>
                                    <a class="btn btn-danger delete" data-confirm="Are you sure to delete this role - '{{ $role->name }}'?" data-toggle='confirmation' href="{{ URL::to('/admin/roles/'. $hashids->encode($role->id)) }}" role="button">
                                        {{ __('Delete') }}
                                    </a>
                                </td>
