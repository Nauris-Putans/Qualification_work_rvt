    ...
    <section class="EmailForm col-lg-8 col-md-12 col-sm-12">
        <div class="container">
            <div class="row justify-content-center" >
                <div class="col-md-8">
                    <div class="card ">
                        <div class="card-header text-white" style="background-color: #182232;">{{ __('Reset Password') }}</div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('password.email') }}" class="RemoveBlueLine">
                                @csrf
                                ...
                                <div class="form-group row mb-0" >
                                    <div class="col-md-6 offset-md-4" >
                                        <button type="submit "style="background-color: #FF8A00; border:none; border-radius: 10px;" class="btn btn-primary">
