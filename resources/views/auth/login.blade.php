            ...
            <div class="container" id="container">
                ...
                <div class="form-container sign-up-container">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <input id="signup_password-confirm" type="password" class="form-control mb-3" name="signup_password_confirmation" required autocomplete="signup_new-password" placeholder="{{ __('Confirm Password') }}">
                        <button type="submit">
                            {{ __('Sign up') }}
                        </button>
                    </form>
                ...
                <div class="overlay-container">
                    <div class="overlay">
                        <div class="overlay-panel overlay-left">
                            <h1>{{ __('Alreay have an account?') }}</h1>
                            <p>{{ __("Easily log in here and continue your monitoring's journey!") }}</p>
                            <button class="ghost" id="signIn">{{ __('Sign In') }}</button>
                        </div>
                        <div class="overlay-panel overlay-right">
                            <h1>{{ __('Hello, Visitor!') }}</h1>
                            <p>{{ __("You steal don't have an account? Easily register and start your jouney in monitoring!") }}</p>
